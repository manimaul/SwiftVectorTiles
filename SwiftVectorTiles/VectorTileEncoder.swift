...
//}
//
//private func createTileEnvelope(buffer b: Int, size s: Int) -> Polygon {
...
//    }
//
//    private func splitAndAddFeatures(layerName name: String, attributes attrs: [String: Attribute]?, geometry geo: [Geometry]) {
//
//        for each in geo {
